...
from builders.suricata.build.modules.dependencies import ensure_dependencies, setup_environment
from builders.suricata.build.modules.download import resolve_rule_bundle
from builders.suricata.build.modules.build import build_suricata
from builders.suricata.build.modules.packaging import package_release
...
def main() -> None:
    ...
    component_root = release_root / "opt" / "wazuh" / "suricata"
